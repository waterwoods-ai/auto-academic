...
**Reference:** Follow the escalation procedure defined in `${CLAUDE_PLUGIN_ROOT}/references/escalation-protocol.md`. The process below is derived from that document.
